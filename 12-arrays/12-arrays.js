...
- Los arrays son objetos de tipo lista cuyo prototipo tiene métodos para realizar operaciones de 
recorrido y mutación     */

var frutas = []; // Array Literal Syntax 

var frutas = ["Manzana", "Platano", "Cereza", "Fresa"]; 
console.log(frutas); 
console.log(frutas.length); // length es una propiedad del array para obtener la cantidad de elementos
console.log(frutas[0]);   // Acceder (por índice) a un elemento del Array 
